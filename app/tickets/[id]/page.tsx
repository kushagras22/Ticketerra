    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 space-y-8">
          ...
          >
            <h1 className="text-2xl font-bold text-gray-900 rubik">
              {ticket.event.name}
            </h1>
            <p className="mt-1 text-gray-600 web-light">
            ...
            {ticket.event.is_cancelled && (
              <p className="mt-4 text-sm text-red-600 web-light">
        ...
        >
          <h3
            className={`text-sm font-medium rubik ${
          ...
          <p
            className={`mt-1 text-sm web-light ${
