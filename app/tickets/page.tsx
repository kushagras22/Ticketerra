    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 rubik">My Tickets</h1>
            <p className="mt-2 text-gray-600 web-light">
        ...
        {upcomingTickets.length > 0 && (
          <div className="mb-12">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 rubik">
              Upcoming Events
            </h2>
        ...
        {tickets.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 rubik">
              No tickets yet
            </h3>
            <p className="text-gray-600 mt-1 web-light">
