      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
            <h2 className="text-2xl font-bold mb-2 rubik">Account Setup</h2>
            <p className="text-blue-100 web-light">
          ...
          <div className="p-6">
            {error ? (
                <div className="bg-red-50 border border-red-100 rounded-lg p-4 flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="font-medium text-red-900 mb-1 rubik">
                            Something went wrong
                        </h3>
                        <p className="text-sm text-red-700">
                            We couldn&apos;t refresh your account link. Please try again or contact support if the problem persists.
                        </p>
                    </div>
                </div>
            ) : (
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 web-light">
                        {accountLinkCreatePending ? "Creating your account link..." : "Redirecting to Stripe..."}
                    </p>
                    {connectedAccountId && (
                        <p className="text-xs text-gray-500 mt-4 web-light">
