              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <p className="tetx-gray-900">₹{event.price.toFixed(2)}</p>
                  </div>
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-blue-900 mb-2 web-light">
                    Event Information
                  </h3>
                  <ul className="space-y-2 text-zinc-700 web-light">
                    <li>
                    • Arrive at least 30 minutes early to ensure smooth
                      entry and preparation.
                    </li>
                    <li>
                    • Check age restrictions to comply with
