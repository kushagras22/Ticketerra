...
const PurchaseTicket = ({ eventId }: { eventId: Id<"events"> }) => {
  ...
  const offerExpiredAt = queuePosition?.offerExpiresAt ?? 0;
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-amber-200">
      <div className="space-y-4">
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          <div className="flex flex-col gap-4">
            ...
            <div className="text-sm text-gray-600 leading-relaxed">
              Your ticket is waiting! Make your purchase before time runs out to
              guarantee your spot at this event.
            </div>
          </div>
        </div>
        ...
        >
          {isLoading ? "Proceeding to payment..." : "Grab your ticket now!"}
        </button>
