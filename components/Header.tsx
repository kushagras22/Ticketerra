        ...
        <div className="hidden lg:block ml-auto">
          <SignedIn>
            <div className="flex items-center gap-3 work-sans">
              ...
              <Link href={"/tickets"}>
                <button className="bg-gray-300 text-gray-800 px-3 py-1.5 text-sm rounded-lg hover:bg-gray-400 transition font-medium">
                  My Tickets
                </button>
              </Link>
            </div>
        ...
        <div className="lg:hidden w-full flex justify-center gap-3">
          <SignedIn>
              ...
              <Link href={"/seller"} className="flex-1">
                <button className="w-full bg-blue-600 text-white px-3 py-1.5 text-sm rounded-lg hover:bg-blue-700 transition font-medium ">
                  Sell Tickets
                </button>
              </Link>

              <Link href={"/tickets"} className="flex-1">
                <button className="w-full bg-gray-300 text-gray-800 px-3 py-1.5 text-sm rounded-lg hover:bg-gray-400 transition border border-gray-300 font-medium">
                  My Tickets
                </button>
              </Link>
