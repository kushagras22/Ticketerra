      ...
      return (
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div className="flex items-center">
            ...
            <span className="text-gray-600">Oops! Event is sold out</span>
          </div>
        </div>
      );
    }
  ...
  return (
    ...
    >
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        <div className="flex items-start justify-between">
          ...
          <div>
            <div className="flex flex-col items-start gap-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900 rubik">
                {event.name}
              </h2>
            </div>
            {isPastEvent && (
        ...
        {/* Event Description */}
        <p className="mt-4 text-gray-600 text-[16px] line-clamp-2 web-light">
          {event.description}
        </p>
